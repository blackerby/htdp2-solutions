...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise288) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; N -> [List-of N]
...
(define (tabulate f n)
  (reverse (build-list ((lambda (n) (add1 n)) n) f)))
