...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise290) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (compose-h loi)
  (foldr (lambda (i j) (beside i j)) empty-image loi))
...
(define (compose-v loi)
  (foldr (lambda (i j) (above i j)) empty-image loi))
