...
; String N -> [List-of [List-of String]]
; produces list of string chunks from s of size n
(check-expect (partition "abcdefg" 3) (bundle (explode "abcdefg") 3))
(check-expect (partition "ab" 3) (bundle '("a" "b") 3))
(check-expect (partition "" 3) (bundle '() 3))
(check-error (partition "bing bong" 0) "n must be greater than 0")
