...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise473) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(define sample-graph
 (list (list 'A 'B 'E)
       (list 'B 'E 'F)
       (list 'C 'D)
