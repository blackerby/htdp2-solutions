...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise452) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; A File is one of: 
; – '()
; – (cons "\n" File)
; – (cons 1String File)
...
; ex. 452: purpose statement given from the book
; termination: every call to first-line is to a shorter version of afile
...
; ex. 452: purpose statement given from the book
; termination: every call to remove-first-line is to a shorter version of afile
