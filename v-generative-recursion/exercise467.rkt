...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise467) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; Algorithm would not terminate for systems of equations where all leading coefficients are zero?
