...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise314) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
#;(define (blue-eyed-child-in-forest? a-forest)
  (foldr (lambda (c b)
           (or (blue-eyed-child? c) b)) #false a-forest))
