...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise369) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; An Xexpr is a list: 
; – (cons Symbol Body)
